...
public class UIEventListenerWrap
{
	...
	static int get_onLongPress(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIEventListener obj = (UIEventListener)o;
			UIEventListener.VoidDelegate ret = obj.onLongPress;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int set_onKey(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIEventListener obj = (UIEventListener)o;
			UIEventListener.KeyCodeDelegate arg0 = (UIEventListener.KeyCodeDelegate)ToLua.CheckDelegate<UIEventListener.KeyCodeDelegate>(L, 2);
			obj.onKey = arg0;
			return 0;
		}
		catch(Exception e)
