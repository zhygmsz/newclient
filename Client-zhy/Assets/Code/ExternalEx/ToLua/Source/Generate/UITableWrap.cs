...
public class UITableWrap
{
	...
	static int GetChildList(IntPtr L)
	{
		try
		{
			...
			UITable obj = (UITable)ToLua.CheckObject<UITable>(L, 1);
	...
	static int get_columns(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index columns on a nil value");
		}
	}
	...
	static int get_cellAlignment(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index cellAlignment on a nil value");
		}
	}
